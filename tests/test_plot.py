...
from matplotlib.cbook import CallbackRegistry  # type: ignore
...
def test_plot_tic_errors(im_i, data, ms):
	fig, ax = plt.subplots()
...
@check_images
def test_plot_mass_spec_alpha(im_i):
	fig, ax = plt.subplots()
...
@check_images
def test_plot_mass_spec_width(im_i):
	fig, ax = plt.subplots()
...
@check_images
def test_plot_mass_spec_linestyle(im_i):
	fig, ax = plt.subplots()
...
def test_plot_mass_spec_errors(im_i, data, tic):
	fig, ax = plt.subplots()
...
@check_images
def test_plot_mass_spec_title(im_i):
	fig, ax = plt.subplots()
...
def test_plot_head2tail_errors(im_i, data):
	fig, ax = plt.subplots()
...
def test_plot_peaks(peak_list, im_i, data, ms):
	fig, ax = plt.subplots()
...
@check_images
def test_plot_peaks_errors(peak_list):
	fig, ax = plt.subplots()
