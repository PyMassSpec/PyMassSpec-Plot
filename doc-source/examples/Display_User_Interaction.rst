...
.. figure:: graphics/Display_User_Interaction_mass_spec.png
	:scale: 80
	:alt: The mass spectrum displayed by PyMassSpec-Plot when a peak in the graphics window is right clicked
